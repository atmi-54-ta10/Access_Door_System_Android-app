...
public class adddatabuatadmin extends AppCompatActivity {
        ...
        simpanButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (username.isEmpty() || noInduk.isEmpty() || role.isEmpty() || card.isEmpty() || job.equals("Job")) {
                    ...
                    Intent i = new Intent(adddatabuatadmin.this, MainActivity.class);
                    startActivity(i);
                }
            }
        });
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST, url, requestBody,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            Toast.makeText(adddatabuatadmin.this, message, Toast.LENGTH_SHORT).show();
                        } catch (JSONException e) {
                            e.printStackTrace();
                            Toast.makeText(adddatabuatadmin.this, "Error: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(adddatabuatadmin.this, "Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }) {
            @Override
